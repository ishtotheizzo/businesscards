...
export default function About() {
  return (
    <div style={{marginBottom: '28px'}}>
      ...
      <br></br><br></br><span contentEditable   style={{ background: 'rgba(1, 1, 1, 1)', fontFamily: 'Arial', color: 'rgba(255,255,255,1)', fontSize: '29px', fontWeight: 'bold', padding: '2px', lineHeight: '32px',wordBreak: 'break-word' }} role='textarea'>Enter Name</span>
